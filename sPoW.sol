...
contract PowShares is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60,000 PowS
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("PoW Shares", "PowS") {
        _mint(msg.sender, 1 ether); // mint 1 PoW Tomb Share for initial pools deployment
